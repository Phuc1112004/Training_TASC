...
import com.example.ecommercebooksales.service.CartItemService;
...
public class CartItemController {
    ...
    @PostMapping
    public ResponseEntity<CartItemResponseDTO> addCartItem(@RequestBody CartItemRequestDTO request) {
